...
toggle("Teleport Above", true, function(s) Settings.KillAura.Teleport = s end)
...
toggle("Speed Boost", false, function(s) Settings.Misc.Speed = s updateSpeed() end)
slider("Speed Value", 16, 200, 50, function(v) Settings.Misc.SpeedVal = v updateSpeed() end)
toggle("Jump Power", false, function(s) Settings.Misc.JumpPower = s updateJump() end)
slider("Jump Value", 50, 300, 100, function(v) Settings.Misc.JumpVal = v updateJump() end)
toggle("Infinite Jump", false, function(s) Settings.Misc.InfJump = s end)
toggle("Gravity", false, function(s) Settings.Misc.Gravity = s updateGrav() end)
slider("Gravity Value", 10, 196, 50, function(v) Settings.Misc.GravVal = v updateGrav() end)
toggle("Fullbright", false, function(s) if s then game:GetService("Lighting").Brightness = 3 else game:GetService("Lighting").Brightness = 1 end end)
...
slider("FOV Value", 30, 120, 90, function(v) Settings.Misc.FOVVal = v if Settings.Misc.FOVChanger then Camera.FieldOfView = v end end)
